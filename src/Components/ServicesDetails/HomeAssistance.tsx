...
import HomeAssistanceImage from '../../assets/HomeAssitanceimage.png';
...
const HomeAssistance: React.FC = () => {
  return (
    <section className="relative bg-gradient-to-br from-white to-gray-50 overflow-hidden min-h-screen px-4 py-10">
      {/* Círculo azul */}
      <motion.div
        className="absolute top-[-110px] md:top-[-160px] left-[-220px] w-78 h-78 md:w-[30rem] md:h-[30rem] bg-[#1D1F3C] rounded-full"
